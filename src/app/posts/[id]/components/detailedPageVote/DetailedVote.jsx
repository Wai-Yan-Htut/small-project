...
export default function DetailedVote({ post, toggleUpvote, toggleDownvote }) {
  return (
    <div className="inline-flex items-center rounded-full bg-slate-50 px-2.5 py-1.5 shadow-sm ring-1 ring-slate-200 transition-colors hover:bg-white hover:ring-cyan-200">
      {post.voteAction === "up" ? (
        <button
          ...
          className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-cyan-500 text-slate-500 transition-colors hover:text-cyan-700"
        >
      ...
      {post.voteAction === "down" ? (
        <button
          ...
          className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-purple-800 text-slate-400 transition-colors hover:text-cyan-700"
        >
